...
function getAllProducts() {
    ...
    $sql = "SELECT id_produk, nama, harga, image_url FROM produk where id_kategori=1"; // Pastikan kolom sesuai dengan nama tabel
    $result = $db->query($sql);
        ...
        <div class="content">
            <div class="sidebar">
                <div class="filter-section">
                    <h3>Keywords</h3>
                    <div>
                        <span>Pria <i class="fas fa-times"></i></span>
